...
namespace BCv1
{
    class Display
    {
        ...
        const byte SSD1306_Address = 0x3D;
        ...
        public void Init(bool proceedOnFail = false)
        {
        ...
        /// <summary>
        /// Extension method to display image from MS.
        /// </summary>
        /// <param name="s">Ssd1306 object.</param>
        /// <param name="image">Image to display.</param>
        internal void DisplayImage(Image<L16> image)
        {
            Int16 width = 128;
            Int16 pages = 8;
            ...
            {
                DisplaySendData(buffer.Skip(i).Take(chunk_size).ToArray());
            }
        }
